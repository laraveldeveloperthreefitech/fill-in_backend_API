                ...
                <div class="row flex-grow">
                  <div class="col-12 grid-margin stretch-card">
                    <div class="card card-rounded">
                      <div class="card-body">
                        <h4 class="card-title card-title-dash">Report List</h4>
                        
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-2">
                          <form action="{{ route('admin.reportOnJob.index') }}" method="GET" class="d-flex flex-wrap align-items-center gap-2 mb-0">
                              ...
                              <a href="{{ route('admin.reportOnJob.index') }}" class="btn btn-warning text-white clear-btn">Clear</a>
                          </form>
                        </div>
                          ...
                          <table class="table select-table">
                            ...
                            <tbody id="indexData">
                              ...
                              <tr id="row-{{ $row->id }}">
                               ...
                               data-url="{{ route('jobRep.delete', ['id' => $row->id]) }}">
