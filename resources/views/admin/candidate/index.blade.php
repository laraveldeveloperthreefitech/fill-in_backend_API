                ...
                <div class="row flex-grow">
                  <div class="col-12 grid-margin stretch-card">
                    <div class="card card-rounded">
                      <div class="card-body">
                        <h4 class="card-title card-title-dash">Candidate List</h4>
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-2">
                            ...
                            <form action="" class="d-flex flex-wrap align-items-center gap-2 mb-0">
                                ...
                                <a type="button" href="{{route('admin.candidate')}}" class="btn btn-warning text-white clear-btn">Clear</a>
                            </form>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    @if($row->profile)
                                      <img src="{{config('filepaths.candidate.public_url') . $row->profile}}" alt="" class="rounded-circle me-2" width="40">
                                    @endif
                                    <div>
                                      <h6>{{$row->name}}</h6>
                                    </div>
                                ...
                                <td><a href="{{route('admin.job',['id' => $row->id,'module' => 'candidate'])}}">{{$row->job_count}}</a></td>
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                  <a href="{{route('candidate.view',['id' =>$row->id])}}" class="btn btn-sm btn-warning text-white me-2 viewData" 
                                          data-row="{{ json_encode($row) }}" title="view">
                                          <i class="mdi mdi-eye menu-icon"></i>
                                      </a>
                                  <a href="{{route('candidate.edit',['id' =>$row->id])}}" class="btn btn-sm btn-primary text-white me-2 editRecruiter" 
...
<script>
   ...
   var ActivateUrl = "{{ route('candidate.active') }}";
   var DeActivateUrl = "{{ route('candidate.de-active') }}";
