...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Candidate Support</h3>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <form class="search-form" action="{{ route('candidate-support.index') }}" method="GET">
                                            ...
                                            <td>
                                                @if(!$row->response_status)
                                                    <button class="btn btn-sm btn-danger respond-btn" 
                                                        data-id="{{ $row->id }}" 
                                                        data-email="{{ $row->candidate->email }}"
                                                    >
                                                        Respond
                                                    </button>
                                                @else
...
<div class="modal fade" id="responseModal" tabindex="-1" role="dialog" aria-labelledby="responseModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form action="{{ route('candidate-support.respond') }}" method="POST">
                @csrf
